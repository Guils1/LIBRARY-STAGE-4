<template>
    <section class="text-gray-600 body-font">
        <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
            <div
                class="lg:flex-grow md:w-1/2 lg:pr-50 md:pr-16 flex flex-col md:items-center md:text-left mb-16 md:mb-0 items-center text-center">
                <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Faça seu cadastro</h1>
                <p class="mb-8 leading-relaxed">Cadastre-se para ter os melhores os livros.</p>
                <div class="flex w-full md:justify-center justify-center items-end">
                    <div class="relative mr-4 md:w-full lg:w-full xl:w-1/2 w-2/4">
                        <label for="hero-field" class="leading-7 text-sm text-gray-600">Nome</label>
                        <input v-model="name" type="text" id="name" name="name" placeholder="Ex: Guilherme Valério"
                        ...
                        <input v-model="email" type="email" id="email" name="email" placeholder="Ex: guilherme.valero@pedbot.com.br"
                            class="w-full bg-gray-100 rounded border bg-opacity-50 border-gray-300 focus:ring-2 focus:ring-indigo-200 focus:bg-transparent focus:border-indigo-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                        ...
                        <input v-model="password" type="password" id="password" name="password" placeholder="Password"
                            class="w-full bg-gray-100 rounded border bg-opacity-50 border-gray-300 focus:ring-2 focus:ring-indigo-200 focus:bg-transparent focus:border-indigo-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                        <p class="text-sm mt-2 text-gray-500 mb-8 w-full">Você já tem uma conta? <a href=""><router-link
                                    to="/login">Entre.</router-link></a></p>
                        <button @click="submit" class="w-full mb-5 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Sign up</button>
                    </div>
                </div>
            ...
            <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                <img id="img" class="object-cover object-center rounded" alt="hero"
                    src="https://img.freepik.com/vetores-gratis/entrar-ilustracao-do-conceito_114360-125.jpg?w=740&t=st=1675637384~exp=1675637984~hmac=8efbc759d84b298b7b52551999913cefaebcfca0b24c3ba607616d1a910b615b">
            </div>
        </div>
    </section>
</template>
