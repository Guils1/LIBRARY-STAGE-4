    ...
    <div class="container px-5 py-24 mx-auto">
      ...
      <div class="flex flex-wrap -m-4">
        <div class="xl:w-1/4 md:w-1/2 p-4">
          <div class="bg-gray-100 p-6 rounded-lg">
            <img class="h-40 rounded w-full object-cover object-center mb-6"
              src="https://s.ebiografia.com/img/ma/ch/machado_de_assis_c.jpg" alt="content" />
            <h3 class="
                  tracking-widest
        ...
        <div class="xl:w-1/4 md:w-1/2 p-4">
          <div class="bg-gray-100 p-6 rounded-lg">
            <img class="h-40 rounded w-full object-cover object-center mb-6"
              src="https://s.ebiografia.com/img/sh/ak/shakespeare_maconha_weed_c.jpg" alt="content" />
            <h3 class="
                  tracking-widest
                  text-indigo-500 text-xs
                  font-medium
        ...
        <div class="xl:w-1/4 md:w-1/2 p-4">
          <div class="bg-gray-100 p-6 rounded-lg">
            <img class="h-40 rounded w-full object-cover object-center mb-6"
              src="https://s.ebiografia.com/img/sa/ra/saramago_c.jpg" alt="content" />
            <h3 class="
                  tracking-widest
                  text-indigo-500 text-xs
                  font-medium
        ...
        <div class="xl:w-1/4 md:w-1/2 p-4">
          <div class="bg-gray-100 p-6 rounded-lg">
            <img class="h-40 rounded w-full object-cover object-center mb-6"
              src="https://s.ebiografia.com/img/fi/oi/fioi_dor_dostoiei_vski1_c.jpg" alt="content" />
            <h3 class="
                  tracking-widest
                  text-indigo-500 text-xs
                  font-medium
      ...
      <div class="lg:w-2/3 mx-auto">
        <div class="flex flex-wrap w-full bg-gray-100 py-32 px-10 relative mb-4">
          <img alt="gallery" class="
                ...
                inset-0
              "
            src="https://tocalivros.s3.amazonaws.com/images/audiolivros/200/o/-/o-homem-mais-rico-da-babilonia-george-s-clason-pablo-spyer-105345.jpg" />
          ...
          <div class="px-2 w-1/2">
            <div class="
              ...
              <img alt="gallery" class="
                    ...
                    absolute
                    inset-0
                  " src="https://i.zst.com.br/thumbs/12/38/35/1458379596.jpg" />
              <div class="text-center relative z-10 w-full">
          ...
          <div class="px-2 w-1/2">
            <div class="
              ...
              <img alt="gallery" class="
                    ...
                    inset-0
                  "
                src="https://resenhandosonhos.com/wp-content/uploads/2020/01/83316365_241746960145069_1740131885742292992_n.jpg" />
              <div class="text-center relative z-10 w-full">
                <a class="mt-3 text-white inline-flex items-center">Learn More
                  <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    class="w-4 h-4 ml-2" viewBox="0 0 24 24">
          ...
          <div class="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
            <div class="flex items-center mb-3">
              <div class="
                  ...
                  ">
                <img
                  src="https://img.icons8.com/external-flaticons-lineal-color-flat-icons/512/external-religions-religion-flaticons-lineal-color-flat-icons-4.png"
                  alt="" />
              </div>
  ...
  <section class="text-gray-600 body-font relative">
    <div class="absolute inset-0 bg-gray-300">
      <iframe width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0" title="map" scrolling="no"
        src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d14772.680370033546!2d-49.981659592187505!3d-22.2336243!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1sunivem!5e0!3m2!1spt-BR!2sbr!4v1673093948089!5m2!1spt-BR!2sbr"></iframe>
    </div>
